export default {
    ...
    EMPTY_PAGE_ICON: 'cly-chart-line-default-test-id-empty-logo',
    EMPTY_PAGE_TITLE: 'cly-chart-line-default-test-id-empty-title',
    EMPTY_PAGE_SUBTITLE: 'cly-chart-line-default-test-id-empty-subtitle',
