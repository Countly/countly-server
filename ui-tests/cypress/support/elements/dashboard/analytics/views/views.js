...
export const viewsMetricCardElements = {
    ...
    TOTAL_USERS_LABEL: 'metric-card-total-users-column-label',
    TOTAL_USERS_VALUE: 'metric-card-total-users-column-number',
    TOTAL_USERS_TOOLTIP: 'metric-card-total-users-column-tooltip',
