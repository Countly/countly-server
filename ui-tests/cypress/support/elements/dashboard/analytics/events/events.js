export default {
    ...
    EMPTY_CHART_ICON: 'cly-chart-time-default-test-id-empty-logo',
    EMPTY_CHART_TITLE: 'cly-chart-time-default-test-id-empty-title',
    EMPTY_CHART_SUBTITLE: 'cly-chart-time-default-test-id-empty-subtitle',
    ...
    //COMPARE EVENTS
    SELECT_EVENTS_COMBOBOX: 'select-events-to-compare-select-input',
