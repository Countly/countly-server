export default {
    ...
    HEALTH_CHECK_RECEIVED_RECEIVED_VALUE: 'metric-card-health-checks-received-description',
    ...
    SDK_ERROR_LOGS_VALUE: 'metric-card-sdk-error-logs-description',
    ...
    SDK_WARN_LOGS_VALUE: 'metric-card-sdk-warn-logs-description',

    HEALTH_CHECK_EMPTY_TABLE_ICON: 'line-options-hcs-empty-logo',
    HEALTH_CHECK_EMPTY_TABLE_TITLE: 'line-options-hcs-empty-title',
    HEALTH_CHECK_EMPTY_TABLE_SUBTITLE: 'line-options-hcs-empty-subtitle',
    ...
    STATUS_EMPTY_TABLE_ICON: 'line-options-status-codes-empty-logo',
    STATUS_EMPTY_TABLE_TITLE: 'line-options-status-codes-empty-title',
    STATUS_EMPTY_TABLE_SUBTITLE: 'line-options-status-codes-empty-subtitle',
    ...
    ERROR_MESSAGES_EMPTY_TABLE_ICON: 'line-options-error-messages-empty-logo',
    ERROR_MESSAGES_EMPTY_TABLE_TITLE: 'line-options-error-messages-empty-title',
    ERROR_MESSAGES_EMPTY_TABLE_SUBTITLE: 'line-options-error-messages-empty-subtitle',
