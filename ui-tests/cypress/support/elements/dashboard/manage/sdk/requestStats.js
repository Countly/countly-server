export default {
    ...
    REQUESTS_RECEIVED_VALUE: 'metric-card-requests-received-description',
    ...
    REQUESTS_CANCELED_VALUE: 'metric-card-requests-canceled-description',
    ...
    REQUESTS_QUEUED_VALUE: 'metric-card-requests-queued-description',

    REQUESTS_EMPTY_TABLE_ICON: 'line-options-requests-empty-logo',
    REQUESTS_EMPTY_TABLE_TITLE: 'line-options-requests-empty-title',
    REQUESTS_EMPTY_TABLE_SUBTITLE: 'line-options-requests-empty-subtitle',

    DELAYS_EMPTY_TABLE_ICON: 'line-options-delays-empty-logo',
    DELAYS_EMPTY_TABLE_TITLE: 'line-options-delays-empty-title',
    DELAYS_EMPTY_TABLE_SUBTITLE: 'line-options-delays-empty-subtitle',
    ...
    RECEIVED_REQUEST_EMPTY_TABLE_ICON: 'cly-chart-bar-test-id-empty-logo',
    RECEIVED_REQUEST_EMPTY_TABLE_TITLE: 'cly-chart-bar-test-id-empty-title',
    RECEIVED_REQUEST_EMPTY_TABLE_SUBTITLE: 'cly-chart-bar-test-id-empty-subtitle',

    CANCELED_REQUEST_BREAKDOWN_BY_REASON_AS_LABEL: 'canceled-request-breakdown-by-reason-as-label',
    CANCELED_REQUEST_BREAKDOWN_BY_REASON_AS_TYPE_SELECT: 'canceled-request-reason-select-input-pseudo-input-label',
