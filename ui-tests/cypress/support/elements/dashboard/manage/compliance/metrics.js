export default {
    ...
    USER_DATA_EXPORTS_TABLE_ICON: 'export-dp-chart-empty-logo',
    USER_DATA_EXPORTS_TABLE_TITLE: 'export-dp-chart-empty-title',
    USER_DATA_EXPORTS_TABLE_SUBTITLE: 'export-dp-chart-empty-subtitle',
    ...
    USER_DATA_PURGES_VALUE: 'user-data-purges-percentage',

    USER_DATA_PURGES_TABLE_ICON: 'purge-dp-chart-empty-logo',
    USER_DATA_PURGES_TABLE_TITLE: 'purge-dp-chart-empty-title',
    USER_DATA_PURGES_TABLE_SUBTITLE: 'purge-dp-chart-empty-subtitle',
