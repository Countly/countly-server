export default {
    ...
    HISTORY_TABLE_EXPORT_BUTTON: 'cly-datatable-n-test-id-export-as-button',
    HISTORY_TABLE_SEARCH_INPUT: 'cly-datatable-n-test-id-datatable-search-input',

    HISTORY_EMPTY_TABLE_ICON: 'cly-datatable-n-test-id-empty-logo',
    HISTORY_EMPTY_TABLE_TITLE: 'cly-datatable-n-test-id-empty-title',
    HISTORY_EMPTY_TABLE_SUBTITLE: 'cly-datatable-n-test-id-empty-subtitle',
