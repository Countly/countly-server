export default {
    ...
    EXPORT_PURGE_HISTORY_TABLE_EXPORT_BUTTON: 'cly-datatable-n-test-id-export-as-button',
    EXPORT_PURGE_HISTORY_TABLE_SEARCH_INPUT: 'cly-datatable-n-test-id-datatable-search-input',
