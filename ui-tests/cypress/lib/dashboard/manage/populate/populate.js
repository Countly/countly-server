...
const clickNumberOfRunsAs10 = () => {
  cy.clickElement(managePopulatePageElementsTEMPLATE_NUMBER_OF_RUNS_10_LABEL)
}

const clickNumberOfRunsAs50 = () => {
  cy.clickElement(managePopulatePageElementsTEMPLATE_NUMBER_OF_RUNS_50_LABEL)
}

const clickNumberOfRunsAs100 = () => {
  cy.clickElement(managePopulatePageElementsTEMPLATE_NUMBER_OF_RUNS_100_LABEL)
}
