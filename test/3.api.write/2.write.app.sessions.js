...
describe('Writing app sessions', function() {
    ...
    describe('start session', function() {
        ...
        describe('Verify sessions (should have 1 session with 1 user)', function() {
            it('Validate aggregator result', function(done) {
                request
                    .get('/o?api_key=' + API_KEY_ADMIN + '&app_id=' + APP_ID + '&method=sessions')
                    .expect(200)
                    .end(function(err, res) {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData"}}, [{_id: null, u: 1, t: 1, n: 1}], done);
            });
        });
        //{"2015":{"1":{"6":{"13":{"e":2,"t":1,"n":1,"u":1},"e":2,"t":1,"Unknown":{"t":1,"n":1,"u":1},"n":1,"u":1,"f":{"0":1},"l":{"0":1}},"u":1,"Unknown":{"u":1,"t":1,"n":1},"f":{"0":1},"l":{"0":1},"e":2,"t":1,"n":1},"u":1,"w1":{"u":1,"Unknown":{"u":1},"f":{"0":1},"l":{"0":1}},"Unknown":{"u":1,"t":1,"n":1},"f":{"0":1},"l":{"0":1},"e":2,"t":1,"n":1},"meta":{"f-ranges":["0"],"l-ranges":["0"],"countries":["Unknown"]}}
        describe('verify users(should have 1 session with 1 user)', function() {
            it('Aggregated data', function(done) {
                request
                    .get('/o?api_key=' + API_KEY_ADMIN + '&app_id=' + APP_ID + '&method=users')
                    .expect(200)
                    .end(function(err, res) {
        ...
        describe('verify countries', function() {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData", "segmentation": "up.cc"}}, [{_id: "Unknown", u: 1, t: 1, n: 1}], done);
            });
        });
    });
    describe('new session without closing previous', function() {
        ...
        describe('Verify sessions', function() {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData"}}, [{_id: null, u: 1, t: 2, n: 1}], done);
            });
        });
        //{"2015":{"1":{"6":{"13":{"e":3,"t":2,"n":1,"u":1},"e":3,"t":2,"Unknown":{"t":2,"n":1,"u":1},"n":1,"u":1,"f":{"0":1},"l":{"0":1}},"u":1,"Unknown":{"u":1,"t":2,"n":1},"f":{"0":1},"l":{"0":1},"e":3,"t":2,"n":1},"u":1,"w1":{"u":1,"Unknown":{"u":1},"f":{"0":1},"l":{"0":1}},"Unknown":{"u":1,"t":2,"n":1},"f":{"0":1},"l":{"0":1},"e":3,"t":2,"n":1},"meta":{"f-ranges":["0"],"l-ranges":["0"],"countries":["Unknown"]}}
        describe('verify users', function() {
        ...
        describe('verify countries', function() {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData", "segmentation": "up.cc"}}, [{_id: "Unknown", u: 1, t: 2, n: 1}], done);
            });
        });
    });
    describe('new user', function() {
        ...
        describe('Verify sessions', function() {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData"}}, [{_id: null, u: 2, t: 3, n: 2}], done);
            });
        });
        //{"2015":{"1":{"6":{"14":{"e":4,"t":3,"n":2,"u":2},"e":4,"t":3,"Unknown":{"t":3,"n":2,"u":2},"n":2,"u":2,"f":{"0":2},"l":{"0":2}},"u":2,"Unknown":{"u":2,"t":3,"n":2},"f":{"0":2},"l":{"0":2},"e":4,"t":3,"n":2},"u":2,"w1":{"u":2,"Unknown":{"u":2},"f":{"0":2},"l":{"0":2}},"Unknown":{"u":2,"t":3,"n":2},"f":{"0":2},"l":{"0":2},"e":4,"t":3,"n":2},"meta":{"f-ranges":["0"],"l-ranges":["0"],"countries":["Unknown"]}}
        describe('verify users', function() {
        ...
        describe('verify countries', function() {
            ...
            it('Validate calculated from granural data', function(done) {
                compareAgainstGranuralData({"query": {"queryName": "aggregatedSessionData", "segmentation": "up.cc"}}, [{_id: "Unknown", u: 2, t: 3, n: 2}], done);
            });
        });
    });
    describe('session duration(duration gets updated in granural/aggregated on ending session)', function() {
        describe('GET request', function() {
            it('should success', function(done) {
                request
                    .get('/i?device_id=' + DEVICE_ID + '&app_key=' + APP_KEY + '&session_duration=30&end_session=1&ignore_cooldown=1')
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
                            return done(err);
        ...
        describe('Verify sessions', function() {
            it('should have 3 sessions, 2 users and 30 duration', function(done) {
                request
                    .get('/o?api_key=' + API_KEY_ADMIN + '&app_id=' + APP_ID + '&method=sessions')
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateSessionData(err, res, done, {meta: {"countries": ["Unknown"], "f-ranges": ["0", "1"], "d-ranges": [ '0', '1' ]}, f: { '0': 2, '1': 1 }, ds: {'0': 1, '1': 1}, u: 2, n: 2, t: 3/*, e: 5*/, d: 30, Unknown: true});
                    });
            });
            it('Validate calculated from granural data', function(done) {
    ...
    describe('session duration without start and then ending it(should be ignored)', function() {
        describe('Send data requests', function() {
            it('session duration', function(done) {
                request
                    .get('/i?device_id=' + DEVICE_ID + 'A&app_key=' + APP_KEY + '&session_duration=30')
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
                            return done(err);
            ...
            it('ending session', function(done) {
                request
                    .get('/i?device_id=' + DEVICE_ID + 'A&app_key=' + APP_KEY + '&end_session=1&ignore_cooldown=1')
                    .expect(200)
                    .end(function(err, res) {
                        if (err) {
                            return done(err);
