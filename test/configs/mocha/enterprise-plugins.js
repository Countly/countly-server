...
if (fs.existsSync(eePluginsPath) && fs.existsSync(defaultPluginsPath)) {
    ...
    // Uses plugins.default.json directly to determine CE plugins (no need for plugins.lite.json copy)
