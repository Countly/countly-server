...
It also normalizes any existing created_at/updated_at that are in milliseconds to seconds.
*/

// Use the core plugins pluginManager
// Script path: core/bin/upgrade/DEV/backfill_audit_fields.js
// Core plugins path: ../../../plugins/pluginManager.js
...
(async() => {
     ...
     * @param {string} creatorField - Field to use for created_by (e.g., 'creator', 'created_by', 'createdBy', 'owner_id')
            ...
            try {
                ...
                const cursor = db.collection(collectionName).find({
                    $or: [
                        ...
                        { created_at: { $type: "number", $gt: MS_THRESHOLD } },
                        { updated_at: { $type: "number", $gt: MS_THRESHOLD } }
                    ]
                });
