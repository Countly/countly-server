...
then
    ...
    $DIR/../../../node_modules/.bin/jsdoc $DIR/../../../frontend/express/public/javascripts/countly $DIR/../../../frontend/express/libs/members.js -R $DIR/../../../frontend/express/public/javascripts/pre-login.js -R $DIR/../../../README.md -c  $DIR/../../../jsdoc_conf.json -d $DIR/../../../frontend/express/public/docs/browser ;
