/*
Script to delete Views collections after migrating to single collection
!! DO NOT RUN IT BEFORE MAKING SURE DATA IS MIGRATED TO SINGLE COLLECTION !!

 Path: $(countly dir)/bin/scripts/data-cleanup
To run this script use the following command
node <path>/remove_old_views_collections.js
*/
var pluginManager = require('../../../plugins/pluginManager.js');

var force = false; //if set to false will skip event collections which do not show up as migrated
if (force === false) {
...
console.log("Removing old Views collections");
var failedCn = 0;
