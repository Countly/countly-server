...
import HealthManagerMain from './components/HealthManagerMain.vue';
import MutationStatusView from './components/MutationStatus.vue';
import AggregatorStatusView from './components/AggregatorStatus.vue';
import IngestionStatusView from './components/IngestionStatus.vue';
import KafkaEventsView from './components/KafkaEvents.vue';
...
// Register menu
app.addMenu("management", {code: "health-manager", permission: "core", url: "#/manage/health", text: i18n('sidebar.management.health-manager'), priority: 85, tabsPath: "/manage/health"});
