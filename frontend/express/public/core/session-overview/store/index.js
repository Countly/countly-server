...
countlySessionOverview.service = {
    ...
    mapSessionOverviewTrends: function(dto) {
        return [
            {
                name: i18n("common.total-sessions"),
                ...
                tooltip: i18n("common.total-sessions-description")
            },
            {
                name: i18n("common.new-sessions"),
                ...
                tooltip: i18n("common.new-sessions-description")
            },
            {
                name: i18n("common.unique-sessions"),
                value: countlyCommon.formatNumber(dto.usage['unique-sessions'].total),
                tooltip: i18n("common.unique-sessions-description"),
                isEstimate: dto.usage['unique-sessions'].isEstimate,
                estimateTooltip: i18n("common.estimation")
            }
        ];
    },
...
export default countlySessionOverview;
