...
(function() {
    ...
    var ParametersDrawer = countlyVue.views.create({
        template: CV.T("/core/remote-config/frontend/public/templates/parameters-drawer.html"),
        props: {
            controls: {
                type: Object
            }
    ...
    var JsonEditor = countlyVue.views.create({
        template: CV.T("/core/remote-config/frontend/public/templates/json-editor.html"),
        data: function() {
            return {
                jsonerror: "",
                jsonstr: ""
    ...
    var ConditionsDrawer = countlyVue.views.create({
        template: CV.T("/core/remote-config/frontend/public/templates/conditions-drawer.html"),
        components: {
            "color-tag": ColorTag
        },
        props: {
        ...
        return new countlyVue.views.BackboneWrapper({
            ...
            templates: [
...

                {
                    ...
                    mapping: {
                        main: "/core/remote-config/frontend/public/templates/main.html",
                        parameters: "/core/remote-config/frontend/public/templates/parameters.html",
                        conditions: "/core/remote-config/frontend/public/templates/conditions.html",
                    }
                }
            ]
        });
