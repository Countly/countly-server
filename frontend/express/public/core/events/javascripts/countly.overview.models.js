...
(function(countlyEventsOverview) {
    ...
    countlyEventsOverview.helpers = {
        ...
        getEventOverview: function(ob) {
            ...
            epu.value = !ob.totalUsersCount ? 0 : Number((ob.totalCount / ob.totalUsersCount).toFixed(1));
            var prevEpu = !ob.prevUsersCount ? 0 : Number((ob.prevTotalCount / ob.prevUsersCount).toFixed(1));
            ...
            epr.value = !ob.totalSessionCount ? 0 : Number((ob.totalCount / ob.totalSessionCount).toFixed(1));
            var prevEpr = !ob.prevSessionCount ? 0 : Number((ob.prevTotalCount / ob.prevSessionCount).toFixed(1));
