                                ...
                                <div\
                                    ...
                                    >\
                                        <slot :name="tab.name" :tab="tab">\
                                            <a v-if=\'tab.route\' :href="tab.route" :data-test-id="\'tab-\' + (tab.dataTestId ? tab.dataTestId : tab.title.toLowerCase().replace(\' \', \'-\')) + \'-link\'"><span :data-test-id="\'tab-\' + (tab.dataTestId ? tab.dataTestId : tab.title.toLowerCase().replace(\' \', \'-\')) + \'-title\'">{{ i18n(tab.title) }}</span></a>\
                                            <span :data-test-id="\'tab-\' + (tab.dataTestId ? tab.dataTestId : tab.title.toLowerCase().replace(\' \', \'-\')) + \'-title\'" v-else>{{ i18n(tab.title) }}</span>\
                                        </slot>\
