    ...
    countlyLocation.getLocationData = function(options) {
        ...
        for (var i = 0; i < locationData.chartData.length; i++) {
            locationData.chartData[i].country_flag =
                "<div class='flag " + locationData.chartData[i].code + "' style='margin-top:2px; background-image:url(" + countlyGlobal.cdn + "images/flags/" + locationData.chartData[i].code + ".png);'></div>" +
