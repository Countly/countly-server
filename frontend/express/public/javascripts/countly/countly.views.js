    ...
    renderCommon:function (isRefresh) {
        ...
        if (!isRefresh) {
			...
			this.dtable = $('#data-table').dataTable($.extend({}, $.fn.dataTable.defaults, {
                ...
                "aoColumns": [
                    { "mData": function(row, type){var meta = {}; try{meta =JSON.parse(row.meta)}catch(e){}; return meta.report_name || "";}, "sType":"string", "sTitle": jQuery.i18n.map["report-manager.name"], "bSortable": true, "sClass":"break" },
                    { "mData": function(row, type){var meta = {}; try{ meta=JSON.parse(row.meta)}catch(e){}; return meta.report_desc || "";}, "sType":"string", "sTitle": jQuery.i18n.map["report-manager.desc"], "bSortable": false, "sClass":"break" },
                    ...
                    { "mData": function(row, type){var meta = {}; try{ meta=JSON.parse(row.meta)}catch(e){}; return meta.autoRefresh ? jQuery.i18n.map["taskmanager.auto"] : jQuery.i18n.map["taskmanager.manual"];}, "sType":"string", "sTitle": jQuery.i18n.map["common.type"], "bSortable": false, "sClass":"break" },
                    { "mData": function(row, type){var meta = {}; try{ meta=JSON.parse(row.meta)}catch(e){}; return meta.period_desc || "";}, "sType":"string", "sTitle": jQuery.i18n.map["report-manager.period"], "bSortable": false, "sClass":"break" },
