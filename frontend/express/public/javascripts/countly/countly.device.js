...
import countlyDeviceList from './countly.device.list.js';
...
createMetricModel(countlyDevice, {name: "devices", estOverrideMetric: "devices"}, jQuery, getDeviceFullName);

export default countlyDevice;
