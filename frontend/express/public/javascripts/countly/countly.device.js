(function(countlyDevice, $, undefined) {
	...
	function deviceFullName(shortName) {
		...
		switch (shortName) {
            ...
            case "iPad2,5":	fullName = "iPad mini WiFi"; break;
            // case "iPad2,6":    fullName = "iPad mini WiFi + Cellular (GSM)"; break;
            // case "iPad2,7":    fullName = "iPad mini WiFi + Cellular (CDMA)"; break;
            
            case "iPad3,4":	fullName = "iPad 4 WiFi"; break;
            // case "iPad3,5":    fullName = "iPad 4 WiFi + Cellular (GSM)"; break;
            // case "iPad3,6":    fullName = "iPad 4 WiFi + Cellular (CDMA)"; break;
