        ...
        if (!isRefresh) {
            ...
            this.dtable = $('.d-table').dataTable($.extend({}, $.fn.dataTable.defaults, {
                ...
                "aoColumns": [
                    ...
                    { "mData": function(row, type){if(type == "display") return "<div class='trend' style='background-image:url("+countlyGlobal["cdn"]+"images/dashboard/"+row.duration.trend+"trend.png);'></div> "+row.duration.total; else return row.duration.total;}, "sType":"string", "sTitle": jQuery.i18n.map["allapps.total-duration"] },
