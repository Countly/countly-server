        ...
        $(document).ready(function() {
            ...
            **/
            ...
            if (countlyAuth.validateAppAdmin()) {
                self.addMenu("management", {code: "applications", url: "#/manage/apps", text: "sidebar.management.applications", icon: '<div class="logo-icon ion-ios-albums"></div>', priority: 30, permission: "admin"});
            }
            if (countlyAuth.validateGlobalAdmin()) {
                self.addMenu("management", {code: "users", url: "#/manage/users", text: "sidebar.management.users", icon: '<div class="logo-icon fa fa-user-friends"></div>', priority: 10, permission: "globaladmin"});
            }
            if (countlyAuth.validateGlobalAdmin()) {
                self.addMenu("management", {code: "jobs", url: "#/manage/jobs", text: "sidebar.management.jobs", icon: '<div class="logo-icon">' + jobsIconSvg + '</div>', priority: 60, permission: "globaladmin"});
            }
