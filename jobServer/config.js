...
const DEFAULT_PULSE_CONFIG = {
    ...
    processEvery: '10 seconds', // Frequency to check for new jobs
    maxConcurrency: 5, // Maximum number of jobs that can run concurrently
    defaultConcurrency: 3, // Default number of jobs that can run concurrently
    lockLimit: 3, // Maximum number of jobs that can be locked at the same time
    defaultLockLimit: 2, // Default number of jobs that can be locked at the same time
