...
plugins.loadConfigs(countlyDb, function(){
    ...
    countlyDb.collection("members").find().toArray(function(err, res){
        ...
        for(var i = 0; i <  res.length; i++){
            ...
            arr.push({emails:[res[i].email], apps:res[i].admin_of || [], metrics:{"analytics":true, "revenue":true, "push":true, "crash":true }, frequency:"daily", hour:0, minute:0, day:1, timezone:"Etc/GMT", user:res[i]._id});
        }
