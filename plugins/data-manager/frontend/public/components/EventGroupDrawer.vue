    ...
    computed: {
        title: function() {
            if (this.controls && this.controls.initialEditedObject && this.controls.initialEditedObject.isEditMode) {
                return i18n('data-manager.edit-event-group');
            }
            else {
                return i18n('data-manager.create-new-event-group');
            }
        },
        eventList: function() {
    ...
    methods: {
        ...
        onSubmit: function(doc) {
            if (doc.isEditMode) {
                ...
                if (!(window._.isEqual(doc, this.$refs.eventGroupDrawer.initialEditedObject))) {
