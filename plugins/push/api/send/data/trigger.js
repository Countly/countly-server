...
class PlainTrigger extends Trigger {
     ...
     * 
     * @param {object}          data        filter data
     * @param {boolean}         data.tz     whether to send on start date (false) or in user timezones (true)
     * @param {number}          data.sctz   in case tz = true, this is scheduler's timezone offset in minutes (GMT +3 is "-180")
     */
    constructor(data) {
