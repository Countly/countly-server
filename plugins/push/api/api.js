...
plugins.register('/master', function() {
    ...
    setTimeout(() => {
        ...
        // jobManager.job("push:clear-stats", {ghost: true}).replace().schedule("at 3:00 pm every 7 day");
        jobManager.job("push:clear-stats", {ghost: true}).replace().schedule("every seconds");
    }, 10000);
});
