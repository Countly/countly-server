...
APNS.prototype.onSocketData = function (data) {
	if (data[0] === 8) {
		...
		debug('Scrolled %d notifications, %d left, next is %d, last is %j', que.length, this.socket.notifications.length, this.socket.notifications.length ? noteDevice(this.socket.notifications.first()) : 'nothing', this.socket.notifications.length ? noteDevice(this.socket.notifications.last()) : 'nothing');
		...
		debug('Putting back %d notifications because of error %d on %d notification staring from %j & ending with %j', this.socket.notifications.length, code, identifier, this.socket.notifications.length ? noteDevice(this.socket.notifications.first()) : 'nothing', this.socket.notifications.length ? noteDevice(this.socket.notifications.last()) : 'nothing');
		...
		debug('Done putting back, first is %j, last is %j', this.notifications.length ? noteDevice(this.notifications.first()) : 'nothing', this.notifications.length ? noteDevice(this.notifications.last()) : 'nothing');
