...
APNS.prototype.onSocketData = function (data) {
	if (data[0] === 8) {
		...
		debug('Scrolled %d notifications, %d left, next is %d, last is %j', que.length, this.socket.notifications.length, this.socket.notifications.length ? noteDevice(this.socket.notifications[0]) : 'nothing', this.socket.notifications.length ? noteDevice(this.socket.notifications[this.socket.notifications.length - 1]) : 'nothing');
		...
		debug('Putting back %d notifications because of error %d on %d notification staring from %j & ending with %j', this.socket.notifications.length, code, identifier, this.socket.notifications.length ? noteDevice(this.socket.notifications[0]) : 'nothing', this.socket.notifications.length ? noteDevice(this.socket.notifications[this.socket.notifications.length - 1]) : 'nothing');
		...
		debug('Done putting back, first is %j, last is %j', this.notifications.length ? noteDevice(this.notifications[0]) : 'nothing', this.notifications.length ? noteDevice(this.notifications[this.notifications.length - 1]) : 'nothing');
...
FixedSizeDequeue.prototype.unshift = function(d) {
	...
	Dequeue.super_.prototype.unshift.apply(this, [d]);
};
