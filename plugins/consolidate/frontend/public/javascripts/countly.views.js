...
(function() {
    ...
    app.addAppManagementInput("consolidate", jQuery.i18n.map["consolidate.plugin-title"], {"consolidate": {input: "cly-select-x", attrs: {mode: "multi-check"}, list: appList, defaultValue: []}});
})();