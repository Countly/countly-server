 ...
 * @param {boolean} separate include separator or not, default to false
...
var countlySources = {};
countlySources.getSourceName = getSourceName;
...
createMetricModel(countlySources, {name: "sources", estOverrideMetric: "sources"}, jQuery, getSourceName);

// Assign to window for backward compatibility with legacy code
window.countlySources = countlySources;

export default countlySources;
