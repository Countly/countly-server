        ...
        computed: {
            ...
            alertTimeOptions() {
                if (
                    ...
                    "rating" &&
                    (Array.isArray(this.alertDataFilterValue) && this.alertDataFilterValue.length)
                ) {
                    // Filter out the "hour" option if the alert data type is "rating" and filter is applied
