        ...
        if (params.qstring.events && params.qstring.events.length && Array.isArray(params.qstring.events)) {
            params.qstring.events = params.qstring.events.filter(function(currEvent){
                if (currEvent.key == "[CLY]_star_rating"){
                    ...
                    var collectionName = 'feedback' + params.qstring.app_key;
                    ...
                    common.db.collection(collectionName)
                        .insert({
                            ...
                            delete currEvent.segmentation.email;
                            delete currEvent.segmentation.comment;       
                            delete currEvent.segmentation.contactMe;   
                            delete currEvent.segmentation.widget_id;     
                            return true;
                        })
                    return true;
                }
