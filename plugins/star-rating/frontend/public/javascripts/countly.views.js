...
(function() {
        ...
        data: function() {
            return {
                ...
                logoDropzoneOptions: {
                    ...
                    dictDefaultMessage: 'LOCALIZATON_WILL_BE_HERE',
                    dictRemoveFile: 'LOCALIZATON_WILL_BE_HERE'
                }
            };
        },
        methods: {
    ...
    var RatingsTab = countlyVue.views.create({
        ...
        methods: {
            ...
            fetch: function() {
                var self = this;
                $.when(starRatingPlugin.requestPlatformVersion(), starRatingPlugin.requestRatingInPeriod(), starRatingPlugin.requesPeriod(), starRatingPlugin.requestFeedbackData())
                    .then(function() {
        ...
        methods: {
            createWidget: function() {
                ...
                this.openDrawer("widget", {
                    ...
                    popup_thanks_message: 'Thank you. We received your message.',
    ...
    var WidgetDetail = countlyVue.views.create({
        ...
        data: function() {
            return {
                ...
                ratingRate: 0,
                comments: [{
                    rating: 1, time: 1, comment: 'yes', email: 'fff@sdf.com'
                },
                {
                    rating: 1, time: 1, comment: 'yes', email: 'fff@sdf.com'
                },
        ...
        methods: {
            ...
            fetch: function() {
                ...
                $.when(starRatingPlugin.requestFeedbackData({widget: self.widget._id}))
                    .then(function() {
    ...
    if (countlyAuth.validateRead(FEATURE_NAME)) {
        ...
        app.route("/feedback/ratings/widgets/:widget", 'widget-detail', function(widget) {
            WidgetDetailView.params = {
                id: widget
            };
            this.renderWhenReady(WidgetDetailView);
        });
