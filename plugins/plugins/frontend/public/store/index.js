...
export function getRelativePlugins(code, direction) {
...
export function toggle(plugins, callback) {
    jQuery.ajax({
        type: "GET",
        ...
        error: function(xhr, textStatus, errorThrown) {
            ...
            var ret = textStatus + " ";
            ret += xhr.status + ": " + jQuery(xhr.responseText).text();
            if (errorThrown) {
                ret += errorThrown + "\n";
            }
            if (callback) {
...
export function updateConfigs(configs, callback) {
    jQuery.ajax({
        type: "GET",
...
export function initializeActiveAppConfigs() {
    return jQuery.ajax({
        type: "GET",
...
export function updateUserConfigs(configs, callback) {
    jQuery.ajax({
        type: "GET",
...
export function getConfigsData() {
    return _configsData;
}

export function getUserConfigsData() {
    return _userConfigsData;
}

export function getThemeList() {
    var themeList = [];
    themeList.push({value: "", label: i18n("configs.no-theme")});
...
export function deleteAccount(configs, callback) {
    jQuery.ajax({
        type: "POST",
...
export function getConfigWarnings(configGroup, key) {
...
export function getTooltipLabel(type) {
    var labels = {
        dataIngestion: i18n('configs.tooltip.data-ingestion'),
        uiFiltering: i18n('configs.tooltip.ui-filtering'),
        serverPerformance: i18n('configs.tooltip.server-performance')
    };
