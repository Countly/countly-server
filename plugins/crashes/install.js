...
pluginManager.dbConnection().then((countlyDb) => {
    countlyDb.collection('apps').find({}).toArray(function(err, apps) {
        ...
        function upgrade(app, done) {
            ...
            countlyDb.collection('app_crashusers' + app._id).ensureIndex({"_id": 1, "is_hidden": 1}, {background: true}, cb);
            countlyDb.collection('app_crashusers' + app._id).ensureIndex({"_id": 1, "name": 1}, {background: true}, cb);
