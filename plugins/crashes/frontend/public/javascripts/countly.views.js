...
app.addPageScript("/users/#", function(){
    if(app.activeView && app.activeView.tabs){
        ...
        app.activeView.dtablecrashes = $('#d-table-crashes').dataTable($.extend({}, $.fn.dataTable.defaults, {
            ...
            "aoColumns": [
                {"mData": function(row, type){return countlyCrashes.getCrashName(row.group);}, "sType":"numeric", "sTitle": jQuery.i18n.map["crashes.error"], "sClass": "break web-50", "bSortable":false,"sWidth": "50%" },
