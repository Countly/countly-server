/*global countlyView,countlyDeviceDetails,countlyAppUsers,countlyDevice,$,countlyConsentManager,countlyGlobal,countlyCommon,moment,CountlyHelpers,jQuery,app,ConsentManagementView,T,Backbone,countlyUserdata,countlyAuth */
    ...
    renderCommon: function(isRefresh) {
        ...
        if (!isRefresh) {
            ...
            $(".cly-button-menu").on("cly-list.click", function(event, clickData) {
                ...
                var have_rights = countlyAuth.validateDelete(self.featureName);
...
app.addPageScript("/users/#", function() {
    if (app.activeView && app.activeView.tabs && countlyAuth.validateRead(app.consentManagementView.featureName)) {
