...
var countlySDK = {};
createMetricModel(countlySDK, {name: "sdks", estOverrideMetric: "sdks"}, jQuery);
...
countlySDK.service = {
    ...
    fetchSDKStats: function() {
        return Promise.all([countlySDK.initialize(), countlyTotalUsers.initialize("sdks")]);
    },
...
countlySDK.getVuexModule = function() {
    return Module("countlySDK", {
        actions: actions,
        submodules: [sdkResource, sdkStats]
    });
};

export default countlySDK;
export { countlySDK };
