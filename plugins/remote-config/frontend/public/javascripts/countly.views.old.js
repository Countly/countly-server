/*global $,countlyView,countlyGlobal,countlyAuth,Handlebars,extendViewWithFilter,RemoteConfigComponents,moment,Backbone,_,CountlyHelpers,countlySegmentation,jQuery,countlyCommon,app,remoteConfigView,countlyRemoteConfig, T, countlyVue */
...
countlyVue.container.registerData('/manage/logger', {
    label: jQuery.i18n.map["remote-config.title"],
    value: "rc"
});
