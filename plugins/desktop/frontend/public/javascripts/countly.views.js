...
$(document).ready(function() {
    if (countlyAuth.validateRead('core')) {
        app.addSubMenuForType("desktop", "analytics", {code: "analytics-technology", url: "#/analytics/technology", text: "sidebar.analytics.technology", priority: 30});
        app.addSubMenuForType("desktop", "analytics", {code: "analytics-geo", url: "#/analytics/geo", text: "sidebar.analytics.geo", priority: 40});
