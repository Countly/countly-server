        ...
        data: function() {
            return {
                internalEventOptions: [
                    {value: "/cohort/enter", label: hooksPlugin.getInternalEventPrettyName("/cohort/enter")},
                    {value: "/cohort/exit", label: hooksPlugin.getInternalEventPrettyName("/cohort/exit")},
                    {value: "/profile-group/enter", label: hooksPlugin.getInternalEventPrettyName("/profile-group/enter")},
                    {value: "/profile-group/exit", label: hooksPlugin.getInternalEventPrettyName("/profile-group/exit")},
                    {value: "/i/app_users/create", label: hooksPlugin.getInternalEventPrettyName("/i/app_users/create")},
                    {value: "/i/app_users/update", label: hooksPlugin.getInternalEventPrettyName("/i/app_users/update")},
                    {value: "/i/app_users/delete", label: hooksPlugin.getInternalEventPrettyName("/i/app_users/delete")},
                    {value: "/i/apps/create", label: hooksPlugin.getInternalEventPrettyName("/i/apps/create")},
                    {value: "/i/apps/update", label: hooksPlugin.getInternalEventPrettyName("/i/apps/update")},
                    {value: "/i/apps/delete", label: hooksPlugin.getInternalEventPrettyName("/i/apps/delete")},
                    {value: "/i/users/create", label: hooksPlugin.getInternalEventPrettyName("/i/users/create")},
                    {value: "/i/users/update", label: hooksPlugin.getInternalEventPrettyName("/i/users/update")},
                    {value: "/i/users/delete", label: hooksPlugin.getInternalEventPrettyName("/i/users/delete")},
                    {value: "/master", label: hooksPlugin.getInternalEventPrettyName("/master")},
                    {value: "/systemlogs", label: hooksPlugin.getInternalEventPrettyName("/systemlogs")},
                    {value: "/crashes/new", label: hooksPlugin.getInternalEventPrettyName("/crashes/new")},
                    {value: "/hooks/trigger", label: hooksPlugin.getInternalEventPrettyName("/hooks/trigger")},
                    {value: "/i/remote-config/add-parameter", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/add-parameter")},
                    {value: "/i/remote-config/update-parameter", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/update-parameter")},
                    {value: "/i/remote-config/remove-parameter", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/remove-parameter")},
                    {value: "/i/remote-config/add-condition", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/add-condition")},
                    {value: "/i/remote-config/update-condition", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/update-condition")},
                    {value: "/i/remote-config/remove-condition", label: hooksPlugin.getInternalEventPrettyName("/i/remote-config/remove-condition")},
                    {value: "/alerts/trigger", label: hooksPlugin.getInternalEventPrettyName("/alerts/trigger")}
                ],
                cohortOptions: [],
                groupOptions: [],
                hookOptions: [],
