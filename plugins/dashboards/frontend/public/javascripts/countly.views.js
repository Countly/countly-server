        ...
        methods: {
            ...
            initGrid: function() {
                ...
                this.grid.on("dragstop", function(event, element) {
                    ...
                    /**
                     * In this case, rather than changing the heights of the other widgets
                     * immediately, lets check if we can reduce dragged widgets height to match
