...
<div class="search">
    <div class="bu-level item" v-for="(item, index) in items" :key="index">
        <div class="bu-level-left left">
            <div class="content bu-level-item bu-is-flex bu-is-flex-direction-column bu-is-align-items-start">
                <div class="info bu-is-flex bu-is-align-items-center">
                    <div class="category">
                       {{ item.sectionTitle }}
                    </div>
                </div>
                ...
                <a v-if="item.type === 'article'" class="link" :href="item.url" target="_blank">
