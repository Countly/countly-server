 ...
 * @typedef {import('../../types/taskmanager').TaskManagerOptions} TaskManagerOptions
 * @typedef {import('../../types/taskmanager').TaskResult} TaskResult
 * @typedef {import('../../types/taskmanager').TaskRuleOptions} TaskRuleOptions
 ...
 *  @param {TaskManagerOptions} options - options object
...
var taskmanager = {
    ...
    * @param {TaskManagerOptions} options - options for the task
    ...
    */
    ...
    /**
    * Mark reports dirty based on rule matching
    * @param {TaskRuleOptions} options - options containing rules
    * @param {function=} callback - callback when done
    */
    markReportsDirtyBasedOnRule: function(options, callback) {
    ...
    * @param {function=} callback - callback when data is stored
    */
    saveResult: function(options, data, callback) {
        options = options || {};
        options.db = options.db || common.db;
        var update = {
    ...
    * @param {function} callback - callback for the result
    */
    getResult: function(options, callback) {
        options.db = options.db || common.db;
    ...
    * @param {function} callback - callback for the result
    */
    getResultByQuery: function(options, callback) {
        options.db = options.db || common.db;
    ...
    * @param {function} callback - callback for the result
    */
    editTask: function(options, callback) {
        options.db = options.db || common.db;
    ...
    * @param {function} callback - callback for the result
    */
    checkResult: function(options, callback) {
        options.db = options.db || common.db;
    ...
    * @param {function} callback - callback for the result
    */
    checkIfRunning: function(options, callback) {
        options = options || {};
        options.db = options.db || common.db;
        var query = {};
        if (options.id) {
    ...
    * @param {function} callback - callback for the result
    */
    getCounts: function(options, callback) {
        options.db = options.db || common.db;
        options.query = options.query || {};
    ...
    * @param {function} callback - callback for the result
    */
    getTableQueryResult: async function(options, callback) {
        options.db = options.db || common.db;
        options.query = options.query || {};
        options.projection = options.projection || {data: 0};
    ...
    * @param {function} callback - callback for the result
    */
    deleteResult: function(options, callback) {
        options.db = options.db || common.db;
    ...
    * @param {function} callback - callback for the result
    */
    deleteAdditionalResults: function(task, options, callback) {
    ...
    * @param {function} callback - callback for the result
    */
    errorResults: function(options, callback) {
        options.db = options.db || common.db;
    ...
    */
    rerunTask: function(options, callback) {
        ...
        * @param {function} callback1 - callback for the result
        */
